...
train_df.to_csv("/home/claude/osfi-e23-project/data/train.csv", index=False)
val_df.to_csv("/home/claude/osfi-e23-project/data/val.csv", index=False)
test_df.to_csv("/home/claude/osfi-e23-project/data/test.csv", index=False)
...
with open("/home/claude/osfi-e23-project/outputs/cleaning_log.json", "w") as f:
