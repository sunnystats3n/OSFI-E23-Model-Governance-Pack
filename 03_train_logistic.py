...
with open("/home/claude/osfi-e23-project/outputs/logistic_metrics.json", "w") as f:
    json.dump(results, f, indent=2)
coef_table.to_csv("/home/claude/osfi-e23-project/outputs/logistic_coefficients.csv", index=False)

with open("/home/claude/osfi-e23-project/outputs/logistic_model.pkl", "wb") as f:
