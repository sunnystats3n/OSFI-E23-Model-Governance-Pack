...
FEATURES_LOG = None
with open("/home/claude/osfi-e23-project/outputs/logistic_model.pkl", "rb") as f:
...
log_metrics.to_csv("/home/claude/osfi-e23-project/outputs/bias_logistic_by_age_band.csv")
xgb_metrics.to_csv("/home/claude/osfi-e23-project/outputs/bias_xgboost_by_age_band.csv")
...
with open("/home/claude/osfi-e23-project/outputs/bias_screening_summary.json", "w") as f:
